// taken from: https://github.com/mattparks/glsltest
...
int main(int argc, char **argv)
{
	...
	Process(reflection, ReadFile(CMAKE_CURRENT_SOURCE_DIR "/sample.vert"), VK_SHADER_STAGE_VERTEX_BIT);
	Process(reflection, ReadFile(CMAKE_CURRENT_SOURCE_DIR "/sample.frag"), VK_SHADER_STAGE_FRAGMENT_BIT);
